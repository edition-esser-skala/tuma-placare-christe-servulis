...
\title{Placare Christe servulis}
\shorttitle{Placare Christe}
\subtitle{Hymnus pro festo omnium Sanctorum\\(A-Wn Mus.Hs.15685)}
\scoring{S (solo), S, A, T, B (coro), cnto, fag, 2 trb, 2 vl, b, org}
\maketitle
...
This edition bases upon a copy in the Austrian National Library. The digital version of the manuscript is available at \url{ http://data.onb.ac.at/rec/AC14297578} (siglum Mus.Hs.15685; no RISM entry).

In general, this edition closely follows the manuscript. Any changes that were introduced by the editor are indicated by italic type (lyrics, dynamics and directions), parentheses (expressive marks and bass figures) or dashes (slurs and ties). Accidentals are used according to modern conventions. Asterisks denote changes that are clarified in the detailed remarks below.\footnote{Abbreviations: A, alto; B, bass; b, basses; cnto, cornetto; Ms, manuscript; org, organ; r, rest; S, soprano; T, tenor; trb,~trombone; vl, violin.}
...
\begin{longtable}{ll L{10cm}}
  ...
  \midrule \endhead
  13  & vl 2       & 2nd quarter in Ms: g′4 \\
  35  & vl 1       & 1st half of bar in Ms: g′4–f′4 \\
  56  & vl 1, 2    & 5th eighth in Ms: e″8 \\
  98  & A          & 3rd quarter in Ms: g′4 \\
  115 & cnto, vl 1 & grace note missing in Ms \\
  \bottomrule
\end{longtable}


This edition has been compiled and checked with utmost diligence. Nevertheless, errors and mistakes cannot be totally excluded. Please report any errors and mistakes to \url{wolfgang@esser-skala.at} or create an issue or pull request on the edition’s GitHub page \url{https://github.com/skafdasschaf/tuma-placare-christe-servulis}. Your help will be greatly appreciated.
